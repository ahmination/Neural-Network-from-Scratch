...
def main():
    ...
    os.makedirs('../Neural-Network-from-Scratch/results/fashion', exist_ok=True)
    
    # Plot training history
    plot_training_history(history, save_path='../Neural-Network-from-Scratch/results/fashion/fashion_mnist_training_history.png')
    
    # Plot confusion matrix
    plot_confusion_matrix(y_test, test_predictions,  class_names=[str(i) for i in range(10)], save_path='../Neural-Network-from-Scratch/results/fashion/fashion_mnist_confusion_matrix.png')
    
    # Plot sample predictions
    plot_sample_predictions(X_test, y_test, test_predictions, num_samples=20, save_path='../Neural-Network-from-Scratch/results/fashion/fashion_mnist_sample_predictions.png')
    
    # Plot misclassified samples
    plot_misclassified(X_test, y_test, test_predictions, num_samples=15, save_path='../Neural-Network-from-Scratch/results/fashion/fashion_mnist_misclassified.png')
    ...
    print(f"Results saved to: ../Neural-Network-from-Scratch/results/fashion/")
