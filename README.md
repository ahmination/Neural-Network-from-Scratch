...
1. The Neural network will be a feed-forward model with a multi-layer architecture.

2. This network will be trained on MNIST, fashion_mnist, mnist_corrupt, and mnist_corrupt.

3. After implementation is finished, experiments shall commence.

# Disclaimers
In hopes of making this project, only a few exceptions shall be made:

1. For data Keras will be used to only load the data

2. Numpy will be used in this project for most of the project, mainly to get a
    close result or at least accurate results

3. Due to some technical difficulties, some files and ideas may have been brought here 
    though in this version, it has been resolved, and the project went through redesigns.
...
### Try to Replicate [MIT's Research](https://arxiv.org/pdf/1803.03635) Findings
